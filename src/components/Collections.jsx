...
const Collections = () => {
  return (
    <div className="lg:h-[70vh] flex flex-col justify-center lg:flex-row items-center bg-gray-400 mt-14 lg:px-32 px-5 pb-2 md:mx-10 mx-5">
      {/* img section */}
      ...
      <div className=" w-full lg:w-2/4 space-y-4 pt-5 text-center lg:text-start">
        ...
        <h3 className=" text-lg font-medium text-bl">
